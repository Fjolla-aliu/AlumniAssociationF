...
namespace AlumniAssociationF.Controllers
{
    public class PartnersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Institution,Email,Contact,City,State")] Partners partners)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Institution,Email,Contact,City,State")] Partners partners)
        {
            if (id != partners.Id)
            {
                return NotFound();
